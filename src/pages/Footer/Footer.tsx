...
const Footer = () => {
    ...
    const logoSrc = "https://res.cloudinary.com/dqkczdjjs/image/upload/v1760827265/hd_s_shmnfn.png"; // Placeholder logo
    ...
    return (
        <footer className="relative w-full mt-10 text-white overflow-hidden">
            ...
            {/* Main Footer Content */}
            <div className="relative z-10 m mx-auto container py-16 md:py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-y-12 md:gap-y-16 lg:gap-8">
                    ...
                    <div className="flex items-center lg:items-start justify-center lg:justify-start">
                      <div className='flex items-center gap-2'>
                          <img src={logoSrc} alt="Eastmond Villas Logo" className="h-16 rounded-full w-auto" />
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex items-center justify-center md:justify-start space-x-4">
                            <a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-200">
                              <img src="https://res.cloudinary.com/dqkczdjjs/image/upload/v1760826820/Frame_dccruw.png" alt="" />
                            </a>
                            <a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-200">
                               <img src="https://res.cloudinary.com/dqkczdjjs/image/upload/v1760826937/Frame_1_m7bui5.png" alt="" />
                            </a>
                            <a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-200">
                              <img src="https://res.cloudinary.com/dqkczdjjs/image/upload/v1760826976/Frame_2_dmncqr.png" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
