      ...
      <div className="bg-white container p-8 rounded-xl shadow-lg border border-gray-200 mx-auto mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-6">
          ...
          <div className="flex items-end">
            <button
              type="button"
              className="flex items-center justify-center w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-teal-500 hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:text-sm h-[42px]"
            >
          ...
          <div className="flex items-end">
            <button
              type="button"
              onClick={handleClick}
              className="flex items-center justify-center w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 sm:text-sm h-[42px]"
            >
              <img
